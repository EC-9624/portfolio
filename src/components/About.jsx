...
function About() {
  return (
    <div className="flex items-center justify-center flex-col text-center text-justify pt-20 pb-6">
      ...
      <p className="text-lg max-w-3xl mb-6 font-bold ">
        ...
        on new challenges.I'm particularly interested in Web development Dev/Ops
