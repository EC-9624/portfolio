...
function About() {
  ...
  Web開発、Dev/Ops やモバイルアプリ開発に興味があります。クリーンで保守可能なコードを書くことに取り組んでおり、業界のトレンドに最新であることを心がけて、自分のスキルを活かす機会を探しています。`;

  const text = lang === "EN" ? text_EN : text_JP;

  return (
    <div className='flex items-center justify-center flex-col text-center pt-20 pb-6 mx-4'>
      <h1 className='text-2xl md:text-4xl mb-1 md:mb-1 font-bold'>Eakudompong Chanoknan</h1>
      <h2 className='text-base md:text-lg  mb-1 font-medium'>エークドッムポン チャノックナン</h2>
